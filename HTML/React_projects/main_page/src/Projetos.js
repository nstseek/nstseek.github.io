...
class Projetos extends React.Component{
    ...
    constructor() {
        super();
        this.state = {
            actualDir: "https://api.github.com/repos/nstseek/nstseek.github.io/contents",
            dirList: {
                empty: true,
                empty_element: <h6>Carregando...</h6>
            }
        }        
    }
    ...
    onItemClick = (obj) => {
        if (obj.back === true){
            if (this.state.actualDir === "https://api.github.com/repos/nstseek/nstseek.github.io/contents"){
                return;
            }
            else {
